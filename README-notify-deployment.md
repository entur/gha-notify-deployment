...
| <a name="input_grafana-annotation-text"></a>[grafana-annotation-text](#input_grafana-annotation-text) | string |  false   | `"deployment of ${{ github.repository }}:${{ github.sha }}"` | Text body for the Grafana <br>annotation. For images, use image <br>name and tag. For other <br>types, use something that both <br>identifies the deployment and version.  |
